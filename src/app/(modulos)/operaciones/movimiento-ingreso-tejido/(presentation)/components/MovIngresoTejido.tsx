...
const MovIngresoTejido: React.FC = () => {
    ...
    const handleCreateEntry = () => {
      router.push("/operaciones/movimiento-ingreso-tejido/crear-mov-ingreso-tejido");
    };
  
    const handleViewDetails = (entryNumber: string, period: number) => {
      router.push(`/operaciones/movimiento-ingreso-tejido/detalles-mov-ingreso-tejido/${entryNumber}?period=${period}`);
    };
          ...
          <div className="max-w-full overflow-x-auto">
            <div className="flex items-center justify-start gap-2 mb-4">
              ...
              <Button
                ...
                onClick={() => router.push('/operaciones/movimiento-ingreso-tejido/crear-mov-ingreso-tejido')}
              >
                CREAR
              </Button>
            </div>
