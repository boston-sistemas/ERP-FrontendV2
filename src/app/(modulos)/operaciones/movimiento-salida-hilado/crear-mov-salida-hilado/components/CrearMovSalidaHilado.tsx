...
import NoteIcon from '@mui/icons-material/Note';
   ...
   const handleOpenFabricDialog = async (fabricId: number) => {
    ...
    const handleSaveSalida = async () => {
      ...
      try {
        ...
        setIngresosSeleccionados([]);
        setDataOS(null);
        router.push(`/operaciones/movimiento-salida-hilado/detalles-mov-salida-hilado/${response.exitNumber}`);
      } catch (error) {
  ...
  <Dialog // Diálogo para ver la información del tejido
      ...
      <div className="mt-4 mb-4">
        <Button
          variant="outlined"
          onClick={() => router.push("/operaciones/movimiento-salida-hilado")}
          sx={{
            borderColor: "#64748b",
            color: "#64748b",
            '&:hover': {
